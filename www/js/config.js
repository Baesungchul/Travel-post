...
(function () {
  ...
  var CFG = {
    ...
    APP_NAME:   '찍고쓰다',
    APP_SHORT:  '찍고쓰다',
    /* ⭐ 앱 한 줄 설명 — **여기가 유일한 원천이다.**
       ☠️ 2026-09-06 이전에는 이 값이 있는데도 아무도 안 쓰고, 화면 세 곳(헤더·설정·빈 화면)이
          각자 같은 문장을 손으로 박아 뒀다. 한 곳만 고치면 나머지가 옛 문장으로 남는 구조였다.
          → 이제 셋 다 CFG.APP_TAGLINE 을 읽는다. 바꿀 땐 여기만 고친다. */
    APP_TAGLINE:'사진으로 쓰는 맛집·여행 후기',
