...
(function () {
  ...
  /* ⭐ 구독 요금제 3단계 (사용자 확정 2026-09-03, 30회 가격은 2026-09-03 재확정)
       · 30회  2,900원 (회당 96.7원)
  ...
  var PLANS = {
    t30:  { id: 't30',  label: '30회 구독',   monthly: 30,  price: 2900,  priceYearly: 29000 },
  ...
  function openPlans(title, msg, adKey) {
    ...
    var ov = overlay({
      ...
      body:
        ...
        '<div class="mini">사진은 늘 기기에 남습니다. 폰 저장소 자동 백업·백업 ZIP 은 구독과 상관없이 언제든 쓸 수 있어요.</div>',
