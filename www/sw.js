...
var SHELL = [
  ...
  './js/cloud.js', './js/iap.js', './js/ads.js', './js/subscription.js', './js/ai.js', './js/auto_backup.js', './js/preview.js', './js/share.js',
  './js/backup.js', './js/map.js', './js/trips.js', './js/plans.js', './js/calendar.js', './js/tabbar.js',
